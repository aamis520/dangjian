                ...
                <!-- banner bgn-->
				  ...
				  <!-- 页面bgn-->     
			       <div xid="body_two" class="body_two">
			           <a href="../sanhuiyike/sanhuiyike_dongtai/sanhuiyike_dongtai.w">
			           <div class="body_two_one"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/sanhuiyike/img/zhibudongtai.png" alt="" xid="image15"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">支部动态</p>
			           </div>
			           </a>
			           
			           <a href="../sanhuiyike/sanhuiyike_jianying/sanhuiyike_jianying.w">
			           <div class="body_two_two"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/sanhuiyike/img/jianyin.png" alt="" xid="image16"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">活动剪影</p>
			           </div>
			           </a>
			           
			           <a href="../sanhuiyike/sanhuiyike_dangke/sanhuiyike_dangke.w">
			           <div class="body_two_three"  style="float:right;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/sanhuiyike/img/jingpindangke.png" alt="" xid="image17"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">精品党课</p>
			           </div>
			           </a>
			       </div>
			       ...
			       <div class="body_gonggao" style="background-color:#FFFFFF; line-height:40px;">
			            ...
			            <span style="font-size:16px;"><b>支部动态</b></span>
			       </div>
