                ...
                <!-- banner bgn-->
				  ...
				  <!-- 页面bgn-->     
			       <div xid="body_two" class="body_two">
			           <a href="../pinpaidangjian/pinpaidangjian_xiangmu/pinpaidangjian_xiangmu.w">
			           <div class="body_two_one"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/pinpaidangjian/img/xiangmu.png" alt="" xid="image15"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">党建+项目</p>
			           </div>
			           </a>
			           
			           <a href="../pinpaidangjian/pinpaidangjian_fuwu/pinpaidangjian_fuwu.w">
			           <div class="body_two_two"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/pinpaidangjian/img/fuwu.png" alt="" xid="image16"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">党建+服务</p>
			           </div>
			           </a>
			           
			           <a href="../pinpaidangjian/pinpaidangjian_guanli/pinpaidangjian_guanli.w">
			           <div class="body_two_three"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/pinpaidangjian/img/guanli.png" alt="" xid="image17"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">党建+管理</p>
			           </div>
			           </a>
			           
			           <a href="../pinpaidangjian/pinpaidangjian_jifenka/pinpaidangjian_jifenka.w">
			           <div class="body_two_four"  style="float:right;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/pinpaidangjian/img/jifenka.png" alt="" xid="image17"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">党员积分卡</p>
			           </div>
			           </a>
			       ...
			       <div class="body_gonggao" style="background-color:#FFFFFF; line-height:40px;">
			            ...
			            <span style="font-size:16px;"><b>党建+项目</b></span>
			       </div>
