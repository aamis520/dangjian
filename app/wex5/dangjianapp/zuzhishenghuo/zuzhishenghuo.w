                ...
                <!-- banner bgn-->
				  ...
				  <!-- 页面bgn-->     
			       <div xid="body_two" class="body_two">
			           <a href="../zuzhishenghuo/zuzhishenghuo_xianfeng/zuzhishenghuo_xianfeng.w">
			           <div class="body_two_one"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/zuzhishenghuo/img/dangyuanxianfeng.png" alt="" xid="image15"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">党员先锋</p>
			           </div>
			           </a>
			           
			           <a href="../zuzhishenghuo/zuzhishenghuo_fazhan/zuzhishenghuo_fazhan.w">
			           <div class="body_two_two"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/zuzhishenghuo/img/dangyuanfazhan.png" alt="" xid="image16"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">党员发展</p>
			           </div>
			           </a>
			           
			           <a href="../zuzhishenghuo/zuzhishenghuo_dongtai/zuzhishenghuo_dongtai.w">
			           <div class="body_two_three"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/zuzhishenghuo/img/zuzhidongtai.png" alt="" xid="image17"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">组织动态</p>
			           </div>
			           </a>
			           
			           <a href="../zuzhishenghuo/zuzhishenghuo_gaikuang/zuzhishenghuo_gaikuang.w">
			           <div class="body_two_four"  style="float:right;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/zuzhishenghuo/img/zuzhigaikuo.png" alt="" xid="image17"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">组织概况</p>
			           </div>
			           </a>
			       </div>
			        ...
			        <div class="body_gonggao" style="background-color:#FFFFFF; line-height:40px;">
			            ...
			            <span style="font-size:16px;"><b>党员先锋</b></span>
			       </div>
