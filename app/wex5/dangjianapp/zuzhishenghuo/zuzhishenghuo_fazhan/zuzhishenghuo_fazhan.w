            ...
            <div class="x-panel-content  x-scroll-view" xid="content3" style="bottom: 0px;"> 
             <!-- 滚动区 -->
              <div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView"
                ...
                <!-- 内容区 -->
                <div class="x-scroll-content" xid="div17" align="left"> 
                <!-- banner bgn-->
                  ...
                  <!-- banner end -->
				  <!-- 页面bgn-->   
				  <div class="body_one" style="background-color:#FFFFFF;">
				  </div>
				  <div class="body_two" style="background-color:#FFFFFF; text-align:center">
				  	<img src="$UI/dangjianapp/zuzhishenghuo/img/diannaoduanfaqi.png"></img>
				  </div>
				  <div class="body_three" style="background-color:#FFFFFF;">
				  </div>
