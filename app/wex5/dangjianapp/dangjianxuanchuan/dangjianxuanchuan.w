                ...
                <!-- banner bgn-->
				  ...
				  <!-- 页面bgn-->     
			       <div xid="body_two" class="body_two">
			           ...
			           <a href="../dangjianxuanchuan/dangjianxuanchuan_yaowen/dangjianxuanchuan_yaowen.w">
			           <div class="body_two_one"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/dangjianxuanchuan/img/dangjianyaowen.png" alt="" xid="image15"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">党建要闻</p>
			           </div>
			           </a>
			           
			           <a href="../dangjianxuanchuan/dangjianxuanchuan_danggui/dangjianxuanchuan_danggui.w">
			           <div class="body_two_two"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/dangjianxuanchuan/img/dangjianchanggui.png" alt="" xid="image16"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">党建党规</p>
			           </div>
			           </a>
			           
			           <a href="../dangjianxuanchuan/dangjianxuanchuan_ziliao/dangjianxuanchuan_ziliao.w">
			           <div class="body_two_three"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/dangjianxuanchuan/img/dangjianzhishi.png" alt="" xid="image17"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">知识资料</p>
			           </div>
			           </a>
			           
			           <a href="../dangjianxuanchuan/dangjianxuanchuan_zhishiku/dangjianxuanchuan_zhishiku.w">
			           <div class="body_two_four"  style="float:right;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/dangjianxuanchuan/img/dangjianzhishiku.png" alt="" xid="image17"></img>
			                <p xid="span2" style="color:#333; font-size:16px;"><![CDATA[党建知识库]]></p>
			           </div>
			           </a>
			        ...
			        <div class="body_gonggao" style="background-color:#FFFFFF; line-height:40px;">
			            ...
			            <span style="font-size:16px;"><b>党建要闻</b></span>
			       </div>
