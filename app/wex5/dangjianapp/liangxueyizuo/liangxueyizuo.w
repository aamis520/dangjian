                ...
                <!-- banner bgn-->
				  ...
				  <!-- 页面bgn-->     
			       <div xid="body_two" class="body_two">
			           <a href="../liangxueyizuo/liangxueyizuo_dongtai/liangxueyizuo_dongtai.w">
			           <div class="body_two_one"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/liangxueyizuo/img/xuexidongtai.png" alt="" xid="image15"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">学习动态</p>
			           </div>
			           </a>
			           
			           <a href="../liangxueyizuo/liangxueyizuo_ziliao/liangxueyizuo_ziliao.w">
			           <div class="body_two_two"  style="float:left;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/liangxueyizuo/img/zhishiziliao.png" alt="" xid="image16"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">知识资料</p>
			           </div>
			           </a>
			           
			           <a href="../liangxueyizuo/liangxueyizuo_chengxiao/liangxueyizuo_chengxiao.w">
			           <div class="body_two_three"  style="float:right;text-align:center;background-color:#FFFFFF;">
			                <img src="$UI/dangjianapp/liangxueyizuo/img/zuodechengxiao.png" alt="" xid="image17"></img>
			                <p xid="span2" style="color:#333; font-size:16px;">“做”的成效</p>
			           </div>
			           </a>
			       </div>
			       ...
			       <div class="body_gonggao" style="background-color:#FFFFFF; line-height:40px;">
			            ...
			            <span style="font-size:16px;"><b>学习动态</b></span>
			       </div>
