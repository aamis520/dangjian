...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1">
   <div class="x-titlebar-left" xid="left1"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="返回" xid="backBtn" icon="icon-arrow-left-c">
      ...
      <div component="$UI/system/components/justep/panel/panel" class="panel panel-default x-card"
        ...
        <ul xid="ul1" class="list-group"> 
          ...
          <li class="list-group-item" xid="li1"> 
            ...
            <span xid="span16"><![CDATA[评分鼓励]]></span>
          </li>  
          <li class="list-group-item" xid="li1"> 
            <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-right"
            ...
            <span xid="span19"><![CDATA[分享推荐]]></span>
          </li>  
          <li class="list-group-item" xid="li1"> 
            <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-right"
            ...
            <span xid="span22"><![CDATA[客服电话]]></span>
          </li> 
  ...
  <span xid="span2"><![CDATA[问题反馈]]></span></li></ul> 
      </div>  
      <div component="$UI/system/components/justep/panel/panel" class="panel panel-default x-card"
        xid="panel4"> 
        <div class="list-group-item" xid="div10"> 
          ...
          <span xid="span25"><![CDATA[设置锁屏图案]]></span>
        </div> 
      </div>
      <div component="$UI/system/components/justep/panel/panel" class="panel panel-default x-card"
        xid="panel2"> 
