	...
	<div class="line-big">
		...
		<div class="xl3 xm3">
			<div class="cat-box">
				...
				<h3 class="cat-title"><a href="<?php echo get_category_link($category);?>" title="<?php echo category_description( $categoryID ); ?>">|&nbsp;<?php single_cat_title(); ?></a><span class="catmore"><a href="<?php echo get_category_link($category);?>">More></a></span></h3>
				<div class="clear"></div>
				<div class="cat-site">
					...
					<?php while (have_posts()) : the_post(); ?>
						...
						<li class="list-title"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php echo cut_str($post->post_title,50); ?></a></li>	
					<?php endwhile; ?>						
					</ul>
