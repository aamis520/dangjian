    ...
    */
    ...
    $message = '<div style="background-color:#f8f8f8; border:1px solid #D2D1CB; color:#111; -moz-border-radius:8px; -webkit-border-radius:8px; -khtml-border-radius:8px; border-radius:8px; font-size:14px; width:702px; margin:0 auto; margin-top:10px;">
		...
		<div style="width:90%; margin:0 auto">
			...
			<p>2.找博客，就上<a href="http://boke112.com" style="color:#BA4C32" target="_blank">boke112导航</a>，请认准网址：<a href="http://boke112.com" style="color:#BA4C32" target="_blank">http://boke112.com</a>!</p>
			<p>3.<a href="http://boke112.com" style="color:#BA4C32" target="_blank">boke112导航</a>宗旨是让广大博客主能够体验到博客互访的方便与快捷服务!</p><br />
		</div>
