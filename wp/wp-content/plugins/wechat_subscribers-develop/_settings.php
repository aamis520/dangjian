    ...
    <form action="options.php" method="POST">
        ...
        <table class="form-table">
            ...
            <tr>
                <th>微信公众平台 AppID</th>
                <td>
                    <input id="appid" class="regular-text" type="text"
                           name="<?php echo $this->option_name; ?>[appid]"
            ...
            <tr>
                ...
                <td>
                    <input id="appsecret" class="regular-text" type="text"
                           name="<?php echo $this->option_name; ?>[appsecret]"
                           value="<?php echo $options['appsecret'] ; ?>" />
                    <p class="description">微信公众平台开发者Secret信息，用于创建自定义菜单</p>
                </td>
            </tr>
        </table>
